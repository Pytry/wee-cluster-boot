package org.xitikit.examples.hazelcast.leader.autoconfigure;
...
@ComponentScan({"org.xitikit.examples.hazelcast.leader.autoconfigure"})
public class ClusterBootAutoConfiguration{
    ...
    @Bean
    @ConfigurationProperties("xitikit.cluster-boot")
